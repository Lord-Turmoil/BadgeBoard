...
namespace BadgeBoard.Api.Modules.BadgeUser.Services.Utils
{
    public static class AccountVerifier
    {
        public static bool VerifyPassword(string? password)
        {
	        ...
	        return !string.IsNullOrEmpty(password) && Regex.IsMatch(password, @"[a-zA-Z0-9_-]{6,16}$", RegexOptions.IgnoreCase);
        }
        ...
        {
            return !string.IsNullOrEmpty(username) && Regex.IsMatch(username, @"^[ a-zA-Z0-9_-]{3,20}$", RegexOptions.IgnoreCase);
        }
